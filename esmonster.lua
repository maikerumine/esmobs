...
bp:register_spawn("esmobs:applmons", {"default:stone","nether:rack", "esmobs:cursed_stone"}, 6, -1, 9000, 1, -30)
...
bp:spawn_specific("esmobs:phoenix", {"air"},{"air"}, 2, -1, 30, 35000, 1, 20, 60)
